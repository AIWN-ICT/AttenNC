"""Relay-side DQN agent wrapper and training utilities."""
...
class DQNAgent_R(nn.Module):
    """Deep Q-learning agent responsible for relay-node actions."""
    ...
    def create_q_network(self):
        """Create the relay-side Q-network instance."""
    ...
    def get_q_val(self, state_batch):
        """Return Q-values for a batch of relay states."""
